...
enum EncryptionAlgo : int {
  ...
  EncryptionAlgo_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  EncryptionAlgo_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class ConnectionMetadata final :
 ...
 public:
  ...
  ConnectionMetadata* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class ServiceMetadata final :
 ...
 public:
  ...
  ServiceMetadata* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  private:
  uint32_t _internal_service_tcp(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_service_tcp() const;
  void _internal_add_service_tcp(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_service_tcp();
  public:
  uint32_t service_tcp(int index) const;
  void set_service_tcp(int index, uint32_t value);
  void add_service_tcp(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      service_tcp() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      mutable_service_tcp();
  ...
  private:
  uint32_t _internal_service_udp(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      _internal_service_udp() const;
  void _internal_add_service_udp(uint32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      _internal_mutable_service_udp();
  public:
  uint32_t service_udp(int index) const;
  void set_service_udp(int index, uint32_t value);
  void add_service_udp(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
      service_udp() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >*
      mutable_service_udp();
  ...
  PROTOBUF_NODISCARD std::string* release_beneficiary_addr();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > service_tcp_;
  mutable std::atomic<int> _service_tcp_cached_byte_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t > service_udp_;
...
class StreamMetadata final :
 ...
 public:
  ...
  StreamMetadata* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint32_t ServiceMetadata::_internal_tcp_port() const {
  return tcp_port_;
}
inline uint32_t ServiceMetadata::tcp_port() const {
  // @@protoc_insertion_point(field_get:pb.ServiceMetadata.tcp_port)
  return _internal_tcp_port();
}
inline void ServiceMetadata::_internal_set_tcp_port(uint32_t value) {
  
  tcp_port_ = value;
}
inline void ServiceMetadata::set_tcp_port(uint32_t value) {
...
inline uint32_t ServiceMetadata::_internal_udp_port() const {
  return udp_port_;
}
inline uint32_t ServiceMetadata::udp_port() const {
  // @@protoc_insertion_point(field_get:pb.ServiceMetadata.udp_port)
  return _internal_udp_port();
}
inline void ServiceMetadata::_internal_set_udp_port(uint32_t value) {
  
  udp_port_ = value;
}
inline void ServiceMetadata::set_udp_port(uint32_t value) {
...
inline uint32_t ServiceMetadata::_internal_service_id() const {
  return service_id_;
}
inline uint32_t ServiceMetadata::service_id() const {
  // @@protoc_insertion_point(field_get:pb.ServiceMetadata.service_id)
  return _internal_service_id();
}
inline void ServiceMetadata::_internal_set_service_id(uint32_t value) {
  
  service_id_ = value;
}
inline void ServiceMetadata::set_service_id(uint32_t value) {
...
inline uint32_t ServiceMetadata::_internal_service_tcp(int index) const {
  return service_tcp_.Get(index);
}
inline uint32_t ServiceMetadata::service_tcp(int index) const {
  // @@protoc_insertion_point(field_get:pb.ServiceMetadata.service_tcp)
  return _internal_service_tcp(index);
}
inline void ServiceMetadata::set_service_tcp(int index, uint32_t value) {
  service_tcp_.Set(index, value);
  // @@protoc_insertion_point(field_set:pb.ServiceMetadata.service_tcp)
}
inline void ServiceMetadata::_internal_add_service_tcp(uint32_t value) {
  service_tcp_.Add(value);
}
inline void ServiceMetadata::add_service_tcp(uint32_t value) {
...
inline uint32_t ServiceMetadata::_internal_service_udp(int index) const {
  return service_udp_.Get(index);
}
inline uint32_t ServiceMetadata::service_udp(int index) const {
  // @@protoc_insertion_point(field_get:pb.ServiceMetadata.service_udp)
  return _internal_service_udp(index);
}
inline void ServiceMetadata::set_service_udp(int index, uint32_t value) {
  service_udp_.Set(index, value);
  // @@protoc_insertion_point(field_set:pb.ServiceMetadata.service_udp)
}
inline void ServiceMetadata::_internal_add_service_udp(uint32_t value) {
  service_udp_.Add(value);
}
inline void ServiceMetadata::add_service_udp(uint32_t value) {
...
inline void ServiceMetadata::set_allocated_beneficiary_addr(std::string* beneficiary_addr) {
  ...
  beneficiary_addr_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), beneficiary_addr,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (beneficiary_addr_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    beneficiary_addr_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline uint32_t StreamMetadata::_internal_service_id() const {
  return service_id_;
}
inline uint32_t StreamMetadata::service_id() const {
  // @@protoc_insertion_point(field_get:pb.StreamMetadata.service_id)
  return _internal_service_id();
}
inline void StreamMetadata::_internal_set_service_id(uint32_t value) {
  
  service_id_ = value;
}
inline void StreamMetadata::set_service_id(uint32_t value) {
  _internal_set_service_id(value);
...
inline uint32_t StreamMetadata::_internal_port_id() const {
  return port_id_;
}
inline uint32_t StreamMetadata::port_id() const {
  // @@protoc_insertion_point(field_get:pb.StreamMetadata.port_id)
  return _internal_port_id();
}
inline void StreamMetadata::_internal_set_port_id(uint32_t value) {
  
  port_id_ = value;
}
inline void StreamMetadata::set_port_id(uint32_t value) {
